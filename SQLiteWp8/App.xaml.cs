...
namespace SQLiteWp8
{
    public partial class App : Application
    {
        ...
        //public static string DB_PATH = Path.Combine(ApplicationData.Current.LocalFolder.Path, "ContactsManager.sqlite");//DataBase Name

        public static string DB_PATH = Path.Combine(Path.Combine(Windows.ApplicationModel.Package.Current.InstalledLocation.Path, "ContactsManager.sqlite"));//DataBase Name
        ...
        public App()
        {
            ...
            //if (!FileExists("ContactsManager.sqlite").Result)
            //{
        ...
        private async void Application_Launching(object sender, LaunchingEventArgs e)
        {
            ...
            {
                // file does not exist
                StorageFile databaseFile = await Windows.ApplicationModel.Package.Current.InstalledLocation.GetFileAsync("ContactsManager.sqlite");
                await databaseFile.CopyAsync(ApplicationData.Current.LocalFolder);
                DB_PATH = Path.Combine(Windows.Storage.ApplicationData.Current.LocalFolder.Path, "ContactsManager.sqlite");
            }
